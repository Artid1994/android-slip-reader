...
# 1. อัปเดต app/build.gradle.kts เป็น versionCode 15
...
# 2. แก้ไข MainActivity.kt คลีนโค้ด Kotlin ทั้งหมดให้ถูกต้อง 100%
...
echo "✅ แก้ไขความถูกต้องของไฟล์ MainActivity.kt และ build.gradle.kts เรียบร้อย!"
